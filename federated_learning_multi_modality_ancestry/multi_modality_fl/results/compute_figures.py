...
def create_runtime_figure_and_table(timer_directory_path: str, output_dir: str):
    """
    Plot runtimes of FL algorithms, and table of all runtimes.
    """
