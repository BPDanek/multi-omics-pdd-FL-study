...
def run_series(fold_idx: int):
    ...
    write_results_path = str(REPO_PARENT / "federated_learning_multi_modality_ancestry" / "multi_modality_fl" / "results" / "manual_experiments_uniform_strat")
    ...
    stratified = False
    # records experiment results
    write_results_path = str(REPO_PARENT / "federated_learning_multi_modality_ancestry" / "multi_modality_fl" / "results" / "manual_experiments_uniform_non_strat")
    delete_dir(REPO_PARENT)
    ...
    stratified = False
    # records experiment results
    write_results_path = str(REPO_PARENT / "federated_learning_multi_modality_ancestry" / "multi_modality_fl" / "results" / "manual_experiments_linear_non_strat")
    delete_dir(REPO_PARENT)
    run_baseline_exp(write_results_path, fold_idx) # next
    delete_dir(REPO_PARENT)
    # run_exp(write_results_path, REPO_PARENT, fold_idx, num_round, num_local_rounds, client_lr, 2, split_method, stratified)
